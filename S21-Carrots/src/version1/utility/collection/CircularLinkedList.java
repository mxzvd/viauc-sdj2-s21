...
{
   private version1.utility.collection.LinearNode<T> rear;
   private int count;
   ...
   public void add(int index, T element)
   {
      ...
      if (count == 0)
      {
         rear = new version1.utility.collection.LinearNode<>(element, rear);
   ...
   public T remove(T element)
   {
      ...
      if (element != null)
      {
         ...
         version1.utility.collection.LinearNode<T> previous = rear;
   ...
   {
      version1.utility.collection.LinearNode<T> current = rear;
      if (current == null)
      {
         return -1;
      }
