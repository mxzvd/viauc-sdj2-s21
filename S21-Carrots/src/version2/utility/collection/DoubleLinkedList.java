...
public class DoubleLinkedList<T> implements ListADT<T>
{
   ...
   private DoubleLinkedNode<T> getNode(int index) // could be more efficient
   {
   ...
   public void add(int index, T element)
   {
      ...
      if (index == 0)
      {
         DoubleLinkedNode<T> newNode = new DoubleLinkedNode<T>(null, element,
               front);
         if (count > 0)
         {
      ...
      else
      {
         ...
         DoubleLinkedNode<T> newNode = new DoubleLinkedNode<T>(previous,
